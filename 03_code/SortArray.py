...
class Array(object):
   ...
   def bubbleSort(self):               #Nuevo bublesort() bidireccional
      inicio = 0
      fin = self.__nItems-1

      for last in range(fin, inicio, -1):        
   ...
   def getMediana(self):
      if self.__nItems % 2 == 0:
         mediana = (self.__a[self.__nItems//2-1] + self.__a[self.__nItems//2])/2
      else:
         mediana = (self.__a[self.__nItems//2])
      return mediana
